...
curl -fsSL https://raw.githubusercontent.com/ricardopadua/dotfiles/main/elixir_environment/.tool-versions -o /opt/data/.tool-versions 
curl -fsSL https://raw.githubusercontent.com/ricardopadua/dotfiles/main/zsh/.zshrc.bkp -o /root/.zshrc \
